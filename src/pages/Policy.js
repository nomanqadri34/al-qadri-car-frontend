...
function PrivacyPolicy() {
  ...
  return (
    ...
    <div>
      ...
      <p>
        1.1 AL qadri car Brands Private Limited ("Company", "we", "us" and "our") respects the privacy of its users accessing its website at www.alqadricar.com ("Website"). For the purposes of this privacy policy ("Privacy Policy") and wherever the context so requires "you", "your", "yourself", "user" shall mean any natural or legal person who accesses or uses the Website (including but not limited to customers, employees, service providers, vendors, suppliers, and manufacturers) and in the event that a natural person is representing a business entity, reference to such terms shall include a reference to the business entity.
      </p>
      <p>
